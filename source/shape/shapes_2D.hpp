...
namespace Shape {
  ...
  class CurvilinearTriangle : public Shape<2> {
  public:
    CurvilinearTriangle() = default;
    CurvilinearTriangle(std::vector<Point<3>>&& nodal_coordinates);
    ...
    HPX_SERIALIZATION_POLYMORPHIC_TEMPLATE(CurvilinearTriangle);
#endif
  };
}
#endif
